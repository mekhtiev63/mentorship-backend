...
func mapDomain(err error) *apperror.Error {
	...
	case errors.Is(err, domain.ErrNotFound):
		return apperror.New(apperror.KindNotFound, "not_found", "request not found")
	...
	case errors.Is(err, domain.ErrInsufficientBonus):
		return apperror.New(apperror.KindValidation, "insufficient_bonus", err.Error())
	case errors.Is(err, domain.ErrRejectReason), errors.Is(err, domain.ErrInvalidMessage):
