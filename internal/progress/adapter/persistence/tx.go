...
// Transactor runs callbacks in a PostgreSQL transaction.
...
// WithinTx executes fn inside a transaction.
...
func querier(ctx context.Context, pool *postgres.Pool) dbConn {
