...
func mapDomain(err error) *apperror.Error {
	...
	case errors.Is(err, domain.ErrNotFound):
		return apperror.New(apperror.KindNotFound, "not_found", "assessment not found")
	case errors.Is(err, domain.ErrForbidden):
		return apperror.New(apperror.KindForbidden, "forbidden", "forbidden")
	case errors.Is(err, domain.ErrInvalidTransition), errors.Is(err, domain.ErrRetryNotAllowed):
		return apperror.New(apperror.KindConflict, "invalid_transition", err.Error())
	case errors.Is(err, domain.ErrProgramIncomplete):
		return apperror.New(apperror.KindValidation, "program_incomplete", err.Error())
	case errors.Is(err, domain.ErrFeedbackRequired), errors.Is(err, domain.ErrReasonRequired),
		errors.Is(err, domain.ErrScheduledRequired):
